...
app = Flask(__name__)
cnx = mysql.connector.connect(user="Jack", password="Zangetsu88", host="dbiownit.mysql.database.azure.com", port=3306, database="{your_database}", ssl_ca="{ca-cert filename}", ssl_disabled=False)
